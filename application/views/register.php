    ...
    <form name="frm_register" class="form-horizontal" action="/index.php/auth/register" method="post">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          ...
          <a id="sendCertno" class="btn" style="">인증번호발송</a>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <textarea id="use_prc" readonly rows="5">
본 약관은 2015년 1월 3일부터 적용됩니다.


제 1 조 목적

이 약관은 내시(이하 "회사")에서 제공하는 내시 및 내시에서 제공하는 제반 서비스(이하 "서비스")에 접속과 사용자에 의해서 업로드 및 다운로드 되어 표시되는 모든 정보, 텍스트, 이미지 및 기타 자료를 이용하는 이용자(이하 "회원")와 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.
...
① 서비스: 개인용 컴퓨터 (PC), TV, 휴대형 단말기, 전기통신설비 등 포함 각종 유무선 장치와 같이 구현되는 단말기와 상관없이 회원이 이용할 수 있는 현자박스 및 현자박스 관련 제반 서비스를 의미합니다. 제반 서비스에는 개발자 및 서비스 제공자가 현자박스 Open Application Programming Interface 서비스와 이를 이용하여 개발한 API 응용 애플리케이션 또는 웹서비스도 포함됩니다.
...
① 이용계약은 회원이 현자박스 서비스 및 제반 서비스에서 제공하는 회원 가입 페이지에서 서비스 이용약관에 동의한 후 이용신청을 하고 신청한 내용에 대해서 회사가 승낙함으로써 체결됩니다.
...
⑦ 회사는 관련 법률 및 회사의 개인정보취급방침에서 정한 바에 따라 회원에게 요청하는 회원정보 및 기타정보 항목을 추가, 삭제 등 변경하여 수집 및 이용할 수 있습니다.
...
④ 회사는 회원과 별도로 서면 계약을 체결하여 현자박스 서비스 및 제반 서비스의 브랜드 특성을 이용할 수 있는 명시적인 권리를 부여하지 아니하는 한, 회원에게 회사 또는 서비스의 상호, 상표, 서비스표, 로고, 도메인 네임 및 기타 식별력 있는 브랜드 특성을 이용할 수 있는 권리를 부여하지 않습니다.
